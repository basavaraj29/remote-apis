...
type Action struct {
	...
	// New in version 2.2: clients capable of using version 2.2 of the
	// specification with a server that advertises using
	// [ServerCapabilities][build.bazel.remote.execution.v2.ServerCapabilities]'s
	// high_api_version as at least 2.2 MUST populate this field instead of that
	// which was deprecated inside the
	// [Command][build.bazel.remote.execution.v2.Command].  If the server does
	// not advertise itself as supporting 2.2 then the client MUST populate the
	// platform properties inside the
	// [Command][build.bazel.remote.execution.v2.Command] as before and SHOULD
	// populate this new member too with the same information to facilitate
	// upgrading.
	// Execution services conforming to 2.2 MUST ignore platform properties
	// specified in the Command and prefer these.
...
type Command struct {
	...
	// the action to allow execution services to make routing decisions based on
	// these without introducing an additional step to reach the CAS to determine
	// the properties. See documentation note in the
...
var fileDescriptor_c43847ba40caac95 = []byte{
	...
	,
}
